...
def getCard(sig, cat, ifilename):
       ...
       p1_1 = RooRealVar(cat.replace("XXX","QCD") + "_p1_1", "p1", 1., lowerLimit, upperLimit)
       p1_2 = RooRealVar(cat.replace("XXX","QCD") + "_p1_2", "p1", 1., lowerLimit, upperLimit)
       p1_3 = RooRealVar(cat.replace("XXX","QCD") + "_p1_3", "p1", 1., lowerLimit, upperLimit)
       p1_4 = RooRealVar(cat.replace("XXX","QCD") + "_p1_4", "p1", 1., lowerLimit, upperLimit)

       p2_1 = RooRealVar(cat.replace("XXX","QCD") + "_p2_1", "p2", 1., lowerLimit, upperLimit)
       p2_2 = RooRealVar(cat.replace("XXX","QCD") + "_p2_2", "p2", 1., lowerLimit, upperLimit)
       p2_3 = RooRealVar(cat.replace("XXX","QCD") + "_p2_3", "p2", 1., lowerLimit, upperLimit)
       p2_4 = RooRealVar(cat.replace("XXX","QCD") + "_p2_4", "p2", 1., lowerLimit, upperLimit)
       
       p3_2 = RooRealVar(cat.replace("XXX","QCD") + "_p3_2", "p3", 1., lowerLimit, upperLimit)
       p3_3 = RooRealVar(cat.replace("XXX","QCD") + "_p3_3", "p3", 1., lowerLimit, upperLimit)
       p3_4 = RooRealVar(cat.replace("XXX","QCD") + "_p3_4", "p3", 1., lowerLimit, upperLimit)
       
       p4_3 = RooRealVar(cat.replace("XXX","QCD") + "_p4_3", "p4", 1., lowerLimit, upperLimit)
       p4_4 = RooRealVar(cat.replace("XXX","QCD") + "_p4_4", "p4", 1., lowerLimit, upperLimit)
       
       p5_4 = RooRealVar(cat.replace("XXX","QCD") + "_p5_4", "p5", 1., lowerLimit, upperLimit)
       ...
       pdfsAlt = [
              PdfInfo(modelAltName+"1", "Alt. Fit 1par", "exp(@1*(@0/13000))", hist=histBkgData,
                      x = varToInfo(mT, True),
                      pars = [
                             VarInfo("_p1_1_alt", "p1", 1., lowAlt, highAlt, 0, "", False),
                      ],
               ),
              PdfInfo(modelAltName+"2", "Alt. Fit 2par", "exp(@1*(@0/13000)) * pow(@0/13000,@2)", hist=histBkgData,
                      x = varToInfo(mT, True),
                      pars = [
                             VarInfo("_p1_2_alt", "p1", 1., lowAlt, highAlt, 0, "", False),
                             VarInfo("_p2_2_alt", "p2", 1., lowAlt, highAlt, 0, "", False),
                      ],
               )#,
              #PdfInfo(modelAltName+"3", "Alt. Fit 3par", "exp(@1*(@0/13000)) * pow(@0/13000,@2*(1+@3*log(@0/13000)))", hist=histBkgData,
               #       x = varToInfo(mT, True),
                #      pars = [
                 #            VarInfo("_p1_3_alt", "p1", 1., lowAlt, highAlt, 0, "", False),
                  #           VarInfo("_p2_3_alt", "p2", 1., lowAlt, highAlt, 0, "", False),
                   #          VarInfo("_p3_3_alt", "p3", 1., lowAlt, highAlt, 0, "", False),
                    #  ],
              # ),
              #PdfInfo(modelAltName+"4", "Alt. Fit 4par", "exp(@1*(@0/13000)) * pow(@0/13000,@2*(1+@3*log(@0/13000)*(1+@4*log(@0/13000))))", hist=histBkgData,
              #        x = varToInfo(mT, True),
              #        pars = [
              #               VarInfo("_p1_4_alt", "p1", 1., lowAlt, highAlt, 0, "", False),
              #               VarInfo("_p2_4_alt", "p2", 1., lowAlt, highAlt, 0, "", False),
              #               VarInfo("_p3_4_alt", "p3", 1., lowAlt, highAlt, 0, "", False),
              #               VarInfo("_p4_4_alt", "p4", 1., lowAlt, highAlt, 0, "", False),
              #        ],
              # )
       ]
       modelAlt = []
