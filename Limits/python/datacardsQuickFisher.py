...
#              nDataEvts = histData.Integral(1, histData.GetXaxis().GetNbins()-1) 
              ...
              if(doModelling):
                     ...
                     p1_11 = RooRealVar(ch_red + "_p1_11", "p1", 1., -30., 30.)
                     p2_11 = RooRealVar(ch_red + "_p2_11", "p2", 1., -30., 30.)

                     p1_21 = RooRealVar(ch_red + "_p1_21", "p1", 1., -30., 30.)
                     p2_21 = RooRealVar(ch_red + "_p2_21", "p2", 1., -30., 30.)
                     p3_21 = RooRealVar(ch_red + "_p3_21", "p3", 1., -30., 30.)

                     p1_12 = RooRealVar(ch_red + "_p1_12", "p1", 1., -30., 30.)
                     p2_12 = RooRealVar(ch_red + "_p2_12", "p2", 1., -30., 30.)
                     p3_12 = RooRealVar(ch_red + "_p3_12", "p3", 1., -30., 30.)

                     p1_31 = RooRealVar(ch_red + "_p1_31", "p1", 1., -30., 30.)
                     p2_31 = RooRealVar(ch_red + "_p2_31", "p2", 1., -30., 30.)
                     p3_31 = RooRealVar(ch_red + "_p3_31", "p3", 1., -30., 30.)
                     p4_31 = RooRealVar(ch_red + "_p4_31", "p4", 1., -30., 30.)

                     p1_22 = RooRealVar(ch_red + "_p1_22", "p1", 1., -30., 30.)
                     p2_22 = RooRealVar(ch_red + "_p2_22", "p2", 1., -30., 30.)
                     p3_22 = RooRealVar(ch_red + "_p3_22", "p3", 1., -30., 30.)
                     p4_22 = RooRealVar(ch_red + "_p4_22", "p4", 1., -30., 30.)

                     p1_13 = RooRealVar(ch_red + "_p1_13", "p1", 1., -30., 30.)
                     p2_13 = RooRealVar(ch_red + "_p2_13", "p2", 1., -30., 30.)
                     p3_13 = RooRealVar(ch_red + "_p3_13", "p3", 1., -30., 30.)
                     p4_13 = RooRealVar(ch_red + "_p4_13", "p4", 1., -30., 30.)

                     p1_41 = RooRealVar(ch_red + "_p1_41", "p1", 1., -30., 30.)
                     p2_41 = RooRealVar(ch_red + "_p2_41", "p2", 1., -30., 30.)
                     p3_41 = RooRealVar(ch_red + "_p3_41", "p3", 1., -30., 30.)
                     p4_41 = RooRealVar(ch_red + "_p4_41", "p4", 1., -30., 30.)
                     p5_41 = RooRealVar(ch_red + "_p5_41", "p5", 1., -30., 30.)

                     p1_32 = RooRealVar(ch_red + "_p1_32", "p1", 1., -30., 30.)
                     p2_32 = RooRealVar(ch_red + "_p2_32", "p2", 1., -30., 30.)
                     p3_32 = RooRealVar(ch_red + "_p3_32", "p3", 1., -30., 30.)
                     p4_32 = RooRealVar(ch_red + "_p4_32", "p4", 1., -30., 30.)
                     p5_32 = RooRealVar(ch_red + "_p5_32", "p5", 1., -30., 30.)

                     p1_23 = RooRealVar(ch_red + "_p1_23", "p1", 1., -30., 30.)
                     p2_23 = RooRealVar(ch_red + "_p2_23", "p2", 1., -30., 30.)
                     p3_23 = RooRealVar(ch_red + "_p3_23", "p3", 1., -30., 30.)
                     p4_23 = RooRealVar(ch_red + "_p4_23", "p4", 1., -30., 30.)
                     p5_23 = RooRealVar(ch_red + "_p5_23", "p5", 1., -30., 30.)

                     p1_14 = RooRealVar(ch_red + "_p1_14", "p1", 1., -30., 30.)
                     p2_14 = RooRealVar(ch_red + "_p2_14", "p2", 1., -30., 30.)
                     p3_14 = RooRealVar(ch_red + "_p3_14", "p3", 1., -30., 30.)
                     p4_14 = RooRealVar(ch_red + "_p4_14", "p4", 1., -30., 30.)
                     p5_14 = RooRealVar(ch_red + "_p5_14", "p5", 1., -30., 30.)

                     modelBkg11_rgp = RooGenericPdf(modelName+"_11_rgp", "Thry. (11)", "pow(1 - @0/13000, @2) * pow(@0/13000, -@1)", RooArgList(mT, p1_11, p2_11))
                     modelBkg21_rgp = RooGenericPdf(modelName+"_21_rgp", "Thry. (21)", "pow(1 - @0/13000, @2 + @3*log(@0/13000) ) * pow(@0/13000, -@1)", RooArgList(mT, p1_21, p2_21, p3_21))
                     modelBkg31_rgp = RooGenericPdf(modelName+"_31_rgp", "Thry. (31)", "pow(1 - @0/13000, @2 + @3*log(@0/13000) + @4*pow(log(@0/13000),2) ) * pow(@0/13000, -@1)", RooArgList(mT, p1_31, p2_31, p3_31, p4_31))
                     modelBkg41_rgp = RooGenericPdf(modelName+"_41_rgp", "Thry. (41)", "pow(1 - @0/13000, @2 + @3*log(@0/13000) + @4*pow(log(@0/13000),2) + @5*pow(log(@0/13000),3) ) * pow(@0/13000, -@1)", RooArgList(mT, p1_41, p2_41, p3_41, p4_41, p5_41))
                     modelBkg12_rgp = RooGenericPdf(modelName+"_12_rgp", "Thry. (12)", "pow(1 - @0/13000, @2) * pow(@0/13000, -@1 - @3*log(@0/13000) )", RooArgList(mT, p1_12, p2_12, p3_12))
                     modelBkg13_rgp = RooGenericPdf(modelName+"_13_rgp", "Thry. (13)", "pow(1 - @0/13000, @2) * pow(@0/13000, -@1 - @3*log(@0/13000) - @4*pow(log(@0/13000),2) )", RooArgList(mT, p1_13, p2_13, p3_13, p4_13))
                     modelBkg14_rgp = RooGenericPdf(modelName+"_14_rgp", "Thry. (14)", "pow(1 - @0/13000, @2) * pow(@0/13000, -@1 - @3*log(@0/13000) - @4*pow(log(@0/13000),2) - @5*pow(log(@0/13000),3) )", RooArgList(mT, p1_14, p2_14, p3_14, p4_14, p5_14))
                     modelBkg22_rgp = RooGenericPdf(modelName+"_22_rgp", "Thry. (22)", "pow(1 - @0/13000, @2 + @3*log(@0/13000) ) * pow(@0/13000, -@1 - @4*log(@0/13000) )", RooArgList(mT, p1_22, p2_22, p3_22, p4_22))
                     modelBkg32_rgp = RooGenericPdf(modelName+"_32_rgp", "Thry. (32)", "pow(1 - @0/13000, @2 + @3*log(@0/13000) + @4*pow(log(@0/13000),2) ) * pow(@0/13000, -@1 - @5*log(@0/13000) )", RooArgList(mT, p1_32, p2_32, p3_32, p4_32, p5_32))
                     modelBkg23_rgp = RooGenericPdf(modelName+"_23_rgp", "Thry. (23)", "pow(1 - @0/13000, @2 + @3*log(@0/13000) ) * pow(@0/13000, -@1 - @4*log(@0/13000) - @5*pow(log(@0/13000),2) )", RooArgList(mT, p1_23, p2_23, p3_23, p4_23, p5_23))
                     ...
                     for i in [11,21,31,41,12,13,14,22,32,23]:
                     ...
                     RTDict = {}
                     FDict = {}
                     pairs = [[11,21],[11,12],[11,31],[11,22],[11,13],[11,41],[11,32],[11,23],[11,14],[21,31],[21,22],[21,41],[21,32],[21,23],[12,22],[12,13],[12,32],[12,23],[12,14],[31,41],[31,32],[22,32],[22,23],[13,23],[13,14]]
                     report += "f1 f2 CL Ft\n"
                     ...
                     aCrit = 0.05
                     for funcs in [[11,21,31,41],[11,21,31,41],[11,21,31,32],[11,21,31,32],[11,21,22,32],[11,21,22,32],[11,21,22,23],[11,21,22,23],[11,12,22,32],[11,12,22,32],[11,12,22,23],[11,12,22,23],[11,12,13,23],[11,12,13,23],[11,12,13,14],[11,12,13,14]]:
                            order = -1
                            i = 0
                            j = 1
                            while order == -1:
...
# ALT FUNC
                     ...
                     modelAlt3.plotOn(xframe, RooFit.Name("modelAlt3"), ROOT.RooFit.LineColor(ROOT.kRed+1), RooFit.Range("Full"))
                     modelAlt4.plotOn(xframe, RooFit.Name("modelAlt4"), ROOT.RooFit.LineColor(ROOT.kRed+2), RooFit.Range("Full"))
                     ...
                     RSS[1] = getRSS(sig, ch, mT, modelAlt1, obsData,  [fitRes1], carddir, nDataEvts)
                     RSS[2] = getRSS(sig, ch, mT, modelAlt2, obsData,  [fitRes2], carddir, nDataEvts)
                     RSS[3] = getRSS(sig, ch, mT, modelAlt3, obsData,  [fitRes3], carddir, nDataEvts)
                     RSS[4] = getRSS(sig, ch, mT, modelAlt4, obsData,  [fitRes4], carddir, nDataEvts)
