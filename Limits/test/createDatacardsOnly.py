...
parser.add_argument('-i', '--input', dest='ifile', type=str, default= "root://cmseos.fnal.gov//store/user/pedrok/SVJ2017/Datacards/trig6/sigfull/",help='Where can I find input histos? trig6/sigfull = new (26 Jul 2021) files created by Kevin')
parser.add_argument('-w', '--workspaceDir', dest='workspaceDir', type=str, default="root://cmseos.fnal.gov//store/user/pedrok/SVJ2017/Limits/datacards_Jul26/",help='Location of F-test output files ws_{}.root')
