...
parser.add_argument('-i', '--input', dest='ifile', type=str, default= "root://cmseos.fnal.gov//store/user/pedrok/SVJ2017/Datacards/trig5/sigfull/",help='Where can I find input histos? trig5/sigfull = new (14 Mar 2021) files created by Kevin')
parser.add_argument('-w', '--workspaceDir', dest='workspaceDir', type=str, default="root://cmseos.fnal.gov//store/user/pedrok/SVJ2017/Limits/datacards_Mar29/",help='Location of F-test output files ws_{}.root')
