...
parser.add_argument("-d","--outdir",dest="outdir",type=str,default="outdir",help="Name of the output directory where to store datacards. Default is outdir")
...
for s in signals:
    ...
    for ch in ch_year:
        getCard(s, ch, ifilename, opt.workspaceDir, opt.outdir, doModelling, opt.mode, opt.bias, True, opt.doSys)
