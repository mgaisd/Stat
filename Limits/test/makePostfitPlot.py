...
if __name__=="__main__":
    ...
    parser.add_argument("-D", "--datacards", dest="datacards", type=str, default="root://cmseos.fnal.gov//store/user/pedrok/SVJ2017/Datacards/trig5/sigfull/", help="datacard histogram location (for prefit)")
