...
REGION=${5} #scsvj18_sr
nTOYS=${6}
expSig=${7}  # expected signal, 0 for now
...
SVJ_NAME="SVJ${mZ}"
#DC_NAME="${SVJ_NAME}_${REGION}__QCD__nominal_template_bias.txt"
#WS_NAME="ws_${SVJ_NAME}_${REGION}__QCD__nominal_template.root"
